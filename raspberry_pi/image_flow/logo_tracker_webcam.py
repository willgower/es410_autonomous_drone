...
image_template = cv2.imread('C:/Users/Aaron/AppData/Local/Programs/Python/Python36/Image Processing Photos/Drone Logo/drone_logo_official.png',0) 
...
while True:
    ...
    if matches > threshold:
        ...
        cv2.putText(frame,'Logo Found',(50,50), cv2.FONT_HERSHEY_COMPLEX, 2 ,(0,255,0), 2)
